...
@bot.command()
async def ayuda(ctx):
    await ctx.send("```php\n Esto es lo que buscas: \n $ayuda Muestra los comandos permitidos. \n $info Informacion del servidor. \n $ping Testeo de respuesta. \n $sub Introduce una pagina y te muestra sus subdominios. Ejemplo: $sub discord.com \n $take Indica si existe un subdominio vulnerable al SubdomainTakeOver. Ejemplo: $take discord.com \n $dir Codigo de respuesta del directorio indicado de todos los subdominios. Ejemplo: $dir discord.com /robots.txt \n $bitcoin Precio del bitcoin actual.```")
